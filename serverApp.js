...
function startServer(chainId) {
  ...
  app.use('/js', express.static(servicePath + '/asset/129/js'));
  app.use('/assets/css', express.static(servicePath + '/asset/129/assets/css'));
  app.use('/assets/js', express.static(servicePath + '/asset/129/assets/js'));
  app.use('/css', express.static(servicePath + '/asset/129/css'));
  app.use('/img', express.static(servicePath + '/asset/129/img'));
  app.use('/fonts', express.static(servicePath + '/asset/129/fonts'));
